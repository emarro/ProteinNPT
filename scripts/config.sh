...
export OHE_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_not_augmented.json
export OHE_MSAT_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_MSAT_final.json
export OHE_Tranception_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_Tranception_final.json
export OHE_ESM1v_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_ESM1v_final.json
export OHE_DeepSequence_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_DeepSequence_final.json
export OHE_TranceptEVE_config_location=$proteinnpt_repo_path/proteinnpt/baselines/model_configs/OHE_TranceptEVE_final.json

# Target config files
export target_config_location_fitness=$proteinnpt_repo_path/proteinnpt/utils/target_configs/fitness.json
export target_config_location_multi_objectives_2=$proteinnpt_repo_path/proteinnpt/utils/target_configs/fitness_multi_objectives_2.json
export target_config_location_multi_objectives_3=$proteinnpt_repo_path/proteinnpt/utils/target_configs/fitness_multi_objectives_3.json
